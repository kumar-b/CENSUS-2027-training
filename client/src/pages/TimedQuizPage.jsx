    ...
    <div>
      <div className="px-4 pt-4 pb-3" style={{ borderBottom: '2px solid var(--tc-border)' }}>
        <h2 className="font-black flex items-center gap-2" style={{ color: 'var(--tc-text)' }}>
          <ClockIcon size={18} color="var(--tc-orange)" /> {t('timedQuiz')} — {t('chapter')} {chapter}
        </h2>
        <p className="text-xs font-bold mt-0.5" style={{ color: 'var(--tc-text-muted)' }}>10 questions · 10 min total</p>
      </div>
